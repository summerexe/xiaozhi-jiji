...
public:
  CompactWifiBoardS3Cam()
    ...
    if (g_servo_controller == nullptr &&
        (SERVO1_GPIO != GPIO_NUM_NC || SERVO2_GPIO != GPIO_NUM_NC)) {
      static ServoController servo(SERVO1_GPIO, SERVO2_GPIO);
      g_servo_controller = &servo;
    }
  }
...
// Export servo controller for display code
extern ServoController *GetServoController() { return g_servo_controller; }
